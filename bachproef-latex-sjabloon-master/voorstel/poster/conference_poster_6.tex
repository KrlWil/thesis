...
\begin{abstract}
Dit werk is een studie van het performantieverschil van de Meltown- en Spectre-patches op een Linux webserver.
Er werd een testopstelling opgezet voor gemakkelijk resultaten te genereren met Vagrant en Ansible. Het resultaat is data van een aantal benchmark- en monitoringstools. De resultaten worden onderzocht en er wordt gezien of ze statistisch significant zijn aan de hand van t-testen.\\
In dit document staat er achtergrond beschreven hoe de spectre/meltdown aanvallen werken en hoe mitigaties de performantie kunnen beïnvloeden.\\
 Deze bachelorproef bevestigd dat de patches wel degelijk performantieverlies met zich meebrengen. Dit is belangrijk voor webmasters die zich afvragen of ze nu meer rekenkracht nodig hebben. De belangrijkste impact zal zijn op werkelijk grootschalige omgevingen zoals cloud-providers, waar zelfs een toename van een paar percent van de belasting extra hardware vereist.
...
\includegraphics[width=1.0\linewidth]{cpu_system.png}
